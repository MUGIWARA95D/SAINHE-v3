...
def render(con: sqlite3.Connection, lang: str = "EN", currency: str = "USD") -> dict:
    ...
    return {
        ...
        "data": {
            "ts"         : macro.get("ts"),
            "vix"        : {"valeur": vix_val, "regime": vix_regime, "text": vix_text},
            "yield_curve": {
                "valeur": yc_val, "inverted": inverted, "regime": yc_regime,
                "us10y": macro.get("us10y"), "us3m": macro.get("us3m"), "text": yc_text,
            },
            "erp"        : {"valeur": erp_val, "regime": erp_regime, "sp500_pe": macro.get("sp500_pe"), "text": erp_text},
            "dxy"        : {
                "valeur": dxy.get("close"), "chg_pct": dxy.get("chg_pct"),
                "ret_1m": dxy.get("ret_1m"), "sparkline": dxy.get("sparkline_json"), "text": dxy_text,
            },
            "sp500"      : {
                "close": sp500.get("close"), "chg_pct": sp500.get("chg_pct"),
                "ret_1y": sp500.get("ret_1y"), "sparkline": sp500.get("sparkline_json"),
            },
            "liq": {
                "fed_walcl_t": liq.get("fed_walcl_t"), "fed_walcl_wk_pct": liq.get("fed_walcl_wk_pct"),
                "fed_walcl_date": liq.get("fed_walcl_date"), "fed_bs_text": fed_bs_text,
                "rrp_b": liq.get("rrp_b"), "rrp_date": liq.get("rrp_date"),
                "tga_b": liq.get("tga_b"), "tga_date": liq.get("tga_date"),
                "ecb_assets_t": liq.get("ecb_assets_t"), "ecb_assets_wk_pct": liq.get("ecb_assets_wk_pct"),
                "ecb_assets_date": liq.get("ecb_assets_date"), "ecb_bs_text": ecb_bs_text,
                "us_m2_yoy": liq.get("us_m2_yoy"), "us_m2_date": liq.get("us_m2_date"), "us_m2_text": us_m2_text,
                "eu_m3_yoy": liq.get("eu_m3_yoy"), "eu_m3_date": liq.get("eu_m3_date"), "eu_m3_text": eu_m3_text,
                "china_m2_yoy": liq.get("china_m2_yoy"), "china_m2_date": liq.get("china_m2_date"),
                "japan_m2_yoy": liq.get("japan_m2_yoy"), "japan_m2_date": liq.get("japan_m2_date"),
                "global_cb_trend": liq.get("global_cb_trend"),
                "hy_oas_us": liq.get("hy_oas_us"), "hy_oas_us_date": liq.get("hy_oas_us_date"), "hy_oas_us_text": hy_us_text,
                "hy_oas_eu": liq.get("hy_oas_eu"), "hy_oas_eu_date": liq.get("hy_oas_eu_date"), "hy_oas_eu_text": hy_eu_text,
                "hy_oas_em": liq.get("hy_oas_em"), "hy_oas_em_date": liq.get("hy_oas_em_date"), "hy_oas_em_text": hy_em_text,
                "bund_10y": liq.get("bund_10y"), "bund_2y": liq.get("bund_2y"),
                "bund_spread": liq.get("bund_spread"), "bund_signal": liq.get("bund_signal"), "bund_date": liq.get("bund_date"),
                "jgb_10y": liq.get("jgb_10y"), "jgb_10y_date": liq.get("jgb_10y_date"),
                "jgb_2y": liq.get("jgb_2y"), "jgb_spread": liq.get("jgb_spread"), "jgb_signal": liq.get("jgb_signal"),
                "cgb_10y": liq.get("cgb_10y"), "cgb_2y": liq.get("cgb_2y"),
                "cgb_spread": liq.get("cgb_spread"), "cgb_signal": liq.get("cgb_signal"),
                "cgb_date": liq.get("cgb_date"), "cgb_text": cgb_text,
                "uk_10y": liq.get("uk_10y"), "uk_10y_date": liq.get("uk_10y_date"),
                "us_tips_10y": liq.get("us_tips_10y"), "us_tips_date": liq.get("us_tips_date"), "us_tips_text": tips_text,
                "us_breakeven_10y": liq.get("us_breakeven_10y"), "us_breakeven_date": liq.get("us_breakeven_date"),
                "copper_price": liq.get("copper_price"), "copper_gold_ratio": liq.get("copper_gold_ratio"), "copper_text": copper_text,
                "jpy_usd": liq.get("jpy_usd"), "jpy_text": jpy_text,
                "cape_us": liq.get("cape_us"), "cape_date": liq.get("cape_date"), "cape_text": cape_text,
                "pe_eu": liq.get("pe_eu"), "pe_jp": liq.get("pe_jp"), "pe_em": liq.get("pe_em"), "pe_cn": liq.get("pe_cn"),
                "gold_stocks": liq.get("gold_stocks"), "gold_text": gold_text,
                "cnh_usd": liq.get("cnh_usd"), "cnh_text": cnh_text,
                "eur_usd": eur_usd, "eur_text": eur_text,
                "aud_usd": aud_usd, "aud_text": aud_text,
                "ts": liq.get("ts"), "date": liq.get("date"),
            },
        },
    }
