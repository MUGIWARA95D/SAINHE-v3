...
def testco_submissions() -> dict:
    """Submissions JSON minimal pour metadata_flags — aucun NT ni amendment."""
    return {
        "cik": "999999",
        ...
        "filings": {
            "recent": {
                ...
                "filingDate": ["2024-02-15", "2024-05-10", "2024-08-12",
                               "2024-11-08", "2023-02-17"],
            }
        },
    }
